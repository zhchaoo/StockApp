 ...
 * Original file: E:\\workspace\\xmppzx\\src\\jxt\\app\\stockzx\\xmpp\\IXmppService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements jxt.app.stockzx.xmpp.IXmppService
{
private static final java.lang.String DESCRIPTOR = "jxt.app.stockzx.xmpp.IXmppService";
...
/**
 * Cast an IBinder object into an jxt.app.stockzx.xmpp.IXmppService interface,
 * generating a proxy if needed.
 */
public static jxt.app.stockzx.xmpp.IXmppService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof jxt.app.stockzx.xmpp.IXmppService))) {
return ((jxt.app.stockzx.xmpp.IXmppService)iin);
}
return new jxt.app.stockzx.xmpp.IXmppService.Stub.Proxy(obj);
}
...
jxt.app.stockzx.xmpp.IXmppListener _arg0;
_arg0 = jxt.app.stockzx.xmpp.IXmppListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements jxt.app.stockzx.xmpp.IXmppService
{
...
/**
	 ...
	 * @param listener 监听对象
	 */
public void registerXmppListener(jxt.app.stockzx.xmpp.IXmppListener listener) throws android.os.RemoteException
{
...
/**
	 ...
	 * @param listener 监听对象
	 */
public void unregisterXmppListener(jxt.app.stockzx.xmpp.IXmppListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	 * 获取新资讯
	 */
public void getNewsList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getNewsList, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getNewsList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
/**
	 * 设置xmpp监听
	 * @param listener 监听对象
